...
public class EncriptacionPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Encriptacion";
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new EncriptacionPersistentManager();
		}
